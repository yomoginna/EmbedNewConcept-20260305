...
initMethods_with_HS = [
    ...
    'category_centroid_by_debiased_hidden_state_mean', 'other_category_centroid_by_debiased_hidden_state_mean',
]
...
def prepareGemmaModel(
    ...
    * special_tokenは全て初期化し, 学習可能な状態にする
    ...
    # *** 訓練対象tokenの埋め込みを初期化 ***
    embed_initializer = EmbedInitializer(propnoun_num_for_init_vec, model, tokenizer)
