...
SEED_NUM=1
NUM_OPTIONS=3
INIT_VEC_TYPES=("categoryCentroid_by_DebiasedHSMixed" "otherCategoryCentroid_by_DebiasedHSMixed" "norm_rand_vocab")
...
# thread0: 2199865, 4epoch以降: -
# thread1: 2201034, 4epoch以降: -(まだ)
# thread2: 2202018
# thread3: 
