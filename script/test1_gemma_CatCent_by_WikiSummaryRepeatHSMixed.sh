...
INIT_VEC_TYPES=("CatCent_by_WikiSummaryRepeatHSMixed" "nearCatCent_by_WikiSummaryRepeatHSMixed" "otherCatCent_by_WikiSummaryRepeatHSMixed")
...
nohup uv --no-progress run python src/test1_gemma_wholeRun.py \
        ...
        > log_Test1_gemma-${MODEL_SIZE}B_lr${LR}_wholeRun${THREAD_ID}_3.log 2>&1 &

# thread0: 3601953, 4epoch以降: - , 
# thread1: 3698843, 4epoch以降: -(まだ) , 
# thread2: 3595220, 4epoch以降: -(まだ), 
# thread3: 1258285
# thread4: 1246010
# thread5: 1314489
