...
NUM_OPTIONS=3
LAYER_INDICES=(10 11)
INIT_VEC_TYPES=("CatCent_by_GlbPrimDebiasedHSMixed" "otherCatCent_by_GlbPrimDebiasedHSMixed") "norm_rand_vocab")
...
# thread0: 102368, 4epoch以降: -
# thread1: 103369, 4epoch以降: -(まだ) 
# thread2: , 4epoch以降: -(まだ)
# thread3: 
# 2446706
# 2447762
