...
INIT_VEC_TYPES=("CatCent_by_WikiSummaryHSMixed" "otherCatCent_by_WikiSummaryHSMixed")
# LAYER_INDICES=(8 10 12)
# LAYER_INDICES=(1 4 12 16 20 24 28 32 36 38 40 44 -1)
...
# thread0: 2861409, 4epoch以降: -
# thread1: 2862340, 4epoch以降: -(まだ) 
# thread2: 2863293, 4epoch以降: -(まだ)
# thread3: 2864264
# thread4: 2865280
# thread5: 2866856
